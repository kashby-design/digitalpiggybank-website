...
- **A bucket in a digital piggy bank app.** Tracks the goal visually with a percentage and remaining amount. (Yes, [we built one](/features) — but the principle works in any app.)
